(function (c, l) {
    ...
    c.fn.fullpage = function (d) {
        function La() {
            ...
            d.anchors.length || (d.anchors =
                c("[data-anchor]").map(function () {
                    console.log(c(this).data("anchor"), "haha");
            ...
            la();
            if (!d.animateAnchor && (a = l.location.hash.replace("#", "").split("index.html")[0], a.length)) {
            ...
            ma();
            n.on("load", function () {
                var a = l.location.hash.replace("#", "").split("index.html"),
                    b = a[0],
                    a = a[1];
                b && V(b, a)
            })
        ...
        function Pa() {
            r.append('<div id="fp-nav"><ul class="left_nav"></ul></div>');
            var a = c("#fp-nav");
            a.addClass(function () {
        ...
        function ma() {
            ...
            d.anchors.length &&
                (a = e);
            b.length && (a = a + "-" + f);
            a = a.replace("index.html", "-").replace("#", "");
